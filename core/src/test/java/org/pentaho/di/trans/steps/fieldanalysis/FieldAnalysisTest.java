...
public class FieldAnalysisTest {
  ...
  private StepMockHelper<FieldAnalysisMeta, FieldAnalysisData> stepMockHelper;

  @Before
  public void setup() {
    String[] fieldNames = new String[] {"TEST"};
    stepMockHelper = new StepMockHelper<FieldAnalysisMeta, FieldAnalysisData>( "TEST", FieldAnalysisMeta.class, FieldAnalysisData.class );
  ...
  public void testProcessRow() throws KettleException {
	  FieldAnalysis aggregateRows =  new FieldAnalysis( stepMockHelper.stepMeta, stepMockHelper.stepDataInterface, 0, stepMockHelper.transMeta, stepMockHelper.trans );
    ...
    FieldAnalysisData data = new FieldAnalysisData();
    data.fieldnrs = new int[ fieldSize ];
    data.counts = new long[ fieldSize ];
    data.values = new Object[ fieldSize ];
    
    data.type = new Object[fieldSize];
    data.distinctValues = new Object[fieldSize];
    data.allValues = new Object[fieldSize];
    data.allNumericValues = new Object[fieldSize];
    data.nullCount = new long[fieldSize];
    data.fieldNames = new Object[fieldSize];
    
          data.max = new Object[fieldSize];
          data.min = new Object[fieldSize];
          data.sum = new Object[fieldSize];
    
          data.mean = new Object[fieldSize];
          data.median = new Object[fieldSize];
          data.stddev = new Object[fieldSize];
          data.skewness = new Object[fieldSize];

          data.isBoolean = new Object[fieldSize];
    ...
    // following is true as we always output a summary, even with zero input rows!
    //assertTrue( aggregateRows.processRow( stepMockHelper.initStepMetaInterface,  data ) );
